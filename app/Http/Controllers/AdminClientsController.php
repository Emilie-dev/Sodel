<?php namespace App\Http\Controllers;
	...
	class AdminClientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Commercial","name"=>"Commercial","join"=>"cms_users,id"];
			...
			//$this->form[] = ["label"=>"Approuvé","name"=>"Approuvé","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
