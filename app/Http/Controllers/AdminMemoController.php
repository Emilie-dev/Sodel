<?php namespace App\Http\Controllers;
	...
	class AdminMemoController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "Mémo";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Expéditeur","name"=>"Commercial_id","join"=>"cms_users,name"];
	    ...
	    */
	    public function hook_query_index(&$query) {
       	        $query-> Where('memo.Commercial_id', CRUDBooster::myId());
	    }
